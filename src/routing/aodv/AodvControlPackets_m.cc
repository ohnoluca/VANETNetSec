//
// Generated file, do not edit! Created by nedtool 5.6 from routing/aodv/AodvControlPackets.msg.
//
...
unsigned int RreqSec::getRreqId() const
{
    return this->rreqId;
}

void RreqSec::setRreqId(unsigned int rreqId)
{
    handleChange();
    this->rreqId = rreqId;
}
...
unsigned int RreqSec::getDestSeqNum() const
{
    return this->destSeqNum;
}

void RreqSec::setDestSeqNum(unsigned int destSeqNum)
{
    handleChange();
    this->destSeqNum = destSeqNum;
}
...
unsigned int RreqSec::getOriginatorSeqNum() const
{
    return this->originatorSeqNum;
}

void RreqSec::setOriginatorSeqNum(unsigned int originatorSeqNum)
{
    handleChange();
    this->originatorSeqNum = originatorSeqNum;
}
...
void RreqSec::setSignature(const char * hash)
{
    handleChange();
...
int RreqSecDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'h' && strcmp(fieldName, "hash") == 0) return base+11;
    if (fieldName[0] == 'l' && strcmp(fieldName, "length") == 0) return base+12;
    if (fieldName[0] == 's' && strcmp(fieldName, "signature") == 0) return base+13;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
void RrepSec::setSignature(const char * hash)
{
    handleChange();
    this->signature = signature;
}
