...
bool verify(int length, std::string message, std::string signatureBase64) {
    ...
    CryptoPP::ByteQueue bytes;
    FileSource file2(
            "/home/veins/workspace.omnetpp/ProgettoNetworkSecurity/keys/pubkeyRSA1024.txt",
            true, new Base64Decoder);
...
void SecureAodv::sendRREP(const Ptr<Rrep>& rrep, const L3Address& destAddr, unsigned int timeToLive)
{
...
const Ptr<Rrep> SecureAodv::createRREP(const Ptr<Rreq>& rreq, IRoute *destRoute, IRoute *originatorRoute, const L3Address& lastHopAddr)
{
...
const Ptr<Rrep> SecureAodv::createGratuitousRREP(const Ptr<Rreq>& rreq, IRoute *originatorRoute)
{
...
void SecureAodv::handleRREP(const Ptr<Rrep>& rrep, const L3Address& sourceAddr)
{
...
void SecureAodv::forwardRREP(const Ptr<Rrep>& rrep, const L3Address& destAddr, unsigned int timeToLive)
{
...
void SecureAodv::forwardRREQ(const Ptr<Rreq>& rreq, unsigned int timeToLive)
{
...
void SecureAodv::sendGRREP(const Ptr<Rrep>& grrep, const L3Address& destAddr, unsigned int timeToLive)
{
...
const Ptr<Rrep> SecureAodv::createHelloMessage()
{
...
void SecureAodv::handleHelloMessage(const Ptr<Rrep>& helloMessage)
{
